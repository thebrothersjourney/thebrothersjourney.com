<div class="flex justify-center lg:-mx-12 my-12 p-6 md:px-12 bg-gray-200 border border-gray-400 text-sm md:rounded shadow">
    ...
    <div id="mc_embed_signup">
        <form action="https://thebrothersjourney.us19.list-manage.com/subscribe/post?u=801efcd6abacd1c9640a9b5d3&amp;id=0729a8e1d8" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
